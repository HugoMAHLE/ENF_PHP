                ...
                <ul class="list-unstyled components">
                    ...
                    <li>
                        ...
                        <ul class="collapse list-unstyled" id="consultasSubmenu">
                            <li><a href="numreloj_consultas_vista.php">Crear Consulta</a></li>
                    ...
                    <li>
                        <a href="buscar_empleado_vista.php">Búsqueda de Empelado</a>
                    </li>
                    <li>
                ...
                <div class="contenedor">    
                   <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" class="formulario" name="buscar">
                       <p id="obligatorio">Los campos marcados con * son obligatorios</p>
                        <div class="campos">
                           <div class="iconos">
                               <input type="text" placeholder="Buscar número de reloj *" name="numreloj" value="<?php if(!$busqueda && isset($numreloj)) echo $numreloj; ?>" required>
                               <i class="fab fa-sistrix" onclick="buscar.submit()"></i>
                           </div>
                           
                           <div class="radios">
                               <p>Tipo de Empleado *</p>
                               <div class="conjunto">
                                   <input class="crecer" type="radio" name="tipo_empleado" value="mahle" <?php if(!$busqueda && isset($tipo_empleado)){ if($tipo_empleado == 'mahle'){ echo 'checked'; }} ?>><p class="opcion1">Interno (MAHLE)</p>
                                   
                                   
                                   <input class="crecer" type="radio" name="tipo_empleado" value="externo" <?php if(!$busqueda && isset($tipo_empleado)){ if($tipo_empleado == 'externo'){ echo 'checked'; }} ?>><p class="opcion2">Externo</p>
                               </div>
                           </div>
