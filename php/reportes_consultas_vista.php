					...
					$.ajax({
						...
						success: function(datos){
							...
							if(info == 'nodata'){
								...
								$(".ul-errors").append("<li>No se encontró ningún registro con los datos ingresados.</li>" + planta); 
							...
							//cero problemas
								...
								if(empleado == 'interno'){
									...
									$("#myTable").html("<thead style='background-color: #09164d; color: white'><tr class='tr-center'><th style='font-size: 14px'>Fecha</th><th style='font-size: 14px'>Número de Reloj</th><th style='font-size: 14px'>Sexo</th><th style='font-size: 14px'>Edad</th><th style='font-size: 14px'>Motivo</th><th style='font-size: 14px'>Diagnóstico</th><th style='font-size: 14px'>Tratamiento</th><th style='font-size: 14px'>Descripción</th><th style='font-size: 14px'>Responsable</th><th style='font-size: 14px'>Empresa</th><th style='font-size: 14px'>Planta</th></tr></thead>");
									
									for(var i = 0; i < len; i++){
										var fecha = info[i].fecha;
										var numreloj = info[i].numreloj;
										var sexo = info[i].sexo;
										var edad = info[i].edad;
