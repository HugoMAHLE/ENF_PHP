...
<html>
    <head>
        ...
        <link rel="stylesheet" href="../css/cambio_contra.css">
                ...
                <div class="contenedor">
                   <div class="contenedor2">    
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" class="formulario">
                        <p id="titulo" class="titulo">Cambio de Contraseña</p>
                        <hr>
                        <p id="obligatorio">Los campos marcados con * son obligatorios</p>
                        
                        <div class="campos">
                            <div class="iconos">
                                <i class="fas fa-user"></i><input type="text" name="user_name" value="<?php echo $usuario; ?>" title="Usuario *" disabled>
                            </div>
                            <!--<div class="iconos">
                                <i class="fas fa-key"></i><input type="password" placeholder="Contraseña Actual*" name="old_pass" required>
                            </div>-->
                            <div class="iconos">
                                <i class="fas fa-key"></i><input type="password" placeholder="Nueva Contraseña *" name="new_pass" required>
                            </div>
                            <div class="iconos">
                                <i class="fas fa-key"></i><input type="password" placeholder="Confirmar Nueva Contraseña *" name="new_pass2" required>
                            </div>
                            ...
                            <?php elseif($guardado === true): ?>
                                <div class="guardado">
                                    <p>La contraseña fue guardada correctamente.</p>
                                </div>
                                <!--Función de redireccionamiento con JS, el header de php no funcionó-->
                                <script language="javascript" type="text/javascript">
                                    function redireccionar(){
                                        window.location = "cambio_contra_vista.php";
                                    }
                                    
                                    setTimeout("redireccionar()", 1250);
                                </script>
                           	<?php elseif($guardado === false): ?>
                                <div class="errores">
                                    <ul>
                                        <?php echo $errores2; ?>
                                    </ul>
