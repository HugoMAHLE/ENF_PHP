...
<html>
    <head>
		...
		<title>Consulta de Externo</title>
        ...
        <link rel="stylesheet" href="../css/consulta_externo.css">
                ...
                <div class="contenedor">
                   <div class="contenedor2">    
                    <form action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" method="post" class="formulario">
                        <p id="titulo" class="titulo">Consulta de Externo</p>
                        
                        <ul class="tabs">
                            <li id="tabs1"><a href="#tab1"><span>Datos del Externo</span></a></li>
                        ...
                        <div class="divisiones">
                            <section id="tab1">
                                <div class="campos">
                                    ...
                                    <div class="iconos">
                                       <i class="fas fa-user"></i><input type="text" placeholder="Nombre Completo *" name="nombrecomp" title="Nombre Completo" value="<?php if(!$registrado && isset($nombre_comp)) echo $nombre_comp; ?>" disabled> 
                                    </div>
                                    
                                    <div class="iconos">
                                        <i class="fas fa-building"></i><input type="text" name="empresa" title="Empresa o Universidad *" value="<?php if(!$registrado && isset($empresa)) echo $empresa; ?>" disabled>
                                    </div>
                                    
                                    <div class="fila">
                                        <div class="check cpract">
											<p id="pract">Practicante</p><label class="label_check"><input type="checkbox" name="practicante" value="Si" <?php if(!$registrado && isset($practicante) && !empty($practicante)) echo 'checked'; ?> disabled><span class="checkmark" id="chk"></span></label>
                                        </div>
                                        <div class="iconos">
                                            <i class="fas fa-birthday-cake icos ico"></i><input type="text" placeholder="Edad" name="edad" id="edad" title="Edad" value="<?php if(!$registrado && isset($edad)) echo $edad; ?>" disabled>
                                        </div>
                                    </div>
